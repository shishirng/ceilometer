...
compute_evtcnt snapshot.create.attempted $seconds $minutes $hours $days $weeks $months  cnt_attempted_rval ttc_attempted_rval
compute_evtcnt snapshot.create.failed $seconds $minutes $hours $days $weeks $months  cnt_failed_rval ttc_failed_rval
...
echo -e "             ----------------------------------"
echo -e "             Snapshot Creation Pass Rate : $passperc%"
